...
const en: Dict = {
  ...
  'gettingStarted.previewBackup': 'Add {items} items, {bundles} bundles, and {logs} log entries',
  ...
  'gettingStarted.doneTitleBackup': 'Backup imported',
  'gettingStarted.doneBodyBackup': 'Added {items} items and {logs} log entries.',
  ...
  'graphView.errorLoading': 'Failed to load graph data.',
  'graphView.noData': 'No data in this range for the selected items.',
  'graphView.kindOccurrence': 'events',
  'graphView.selfScaledNote': 'Each series is scaled to its own range for visual comparison.',
  ...
  'sereus.addGuest': 'Invite a guest',
  'sereus.generating': 'Working…',
  'sereus.keyCreated': 'Authority key ready.',
  'sereus.actionFailed': 'Could not complete that',
  'sereus.seedTitle': 'Node seed',
  'sereus.seedBody': 'Give this seed to your drone/server (via cadre-cli) to add it to your cadre. It contains membership secrets — share it only over a trusted channel.',
  'sereus.inviteTitle': 'Guest invitation',
  'sereus.inviteBody': 'Share this invitation with your guest (e.g. a health professional). It grants access to your health strand and expires in 24 hours.',
  'sereus.copy': 'Copy',
  'sereus.close': 'Close',
  'sereus.removeLocalNote': 'Removed from this view. Full removal from the cadre control database is not yet available.',
  'sereus.connect': 'Connect',
  'sereus.connectBody': 'Enter the bootstrap address of a Linux cadre node (drone/server). It looks like /ip4/<host>/tcp/4002/ws/p2p/<peerId>. The node must already trust this device’s owner key.',
  'sereus.connectPlaceholder': '/ip4/…/tcp/4002/ws/p2p/…',
  'sereus.connected': 'Connected',
  'sereus.connectedBody': 'Dialed the node and saved it. Your health data will replicate to it.',
  'sereus.showOwnerKey': 'Show this device’s owner key (for the node to trust)',
  'sereus.ownerKeyTitle': 'This device’s owner key',
  'sereus.ownerKeyBody': 'Give this public key to your Linux cadre node so it trusts this device (cadre-cli --owner, or CADRE_OWNER_KEYS). It is a public key — safe to share.',
  'sereus.ownerKeyUnavailable': 'Owner key not available yet — try again in a moment.',

  'reminders.title': 'Reminders',
  'reminders.interval': "Remind me if I haven't logged anything in:",
  'reminders.off': 'Off',
  'reminders.hours': '{count} hours',
  'reminders.scheduledTitle': 'Scheduled reminders',
  'reminders.scheduledEmpty': 'No scheduled reminders yet. Tap + to add one.',
  'reminders.add': 'Add reminder',
  'reminders.labelPlaceholder': 'Label (optional)',
  'reminders.deleteTitle': 'Delete reminder?',
  'reminders.deleteBody': 'This reminder will be removed.',
  'reminders.delete': 'Delete',
  'reminders.cancel': 'Cancel',
  'reminders.permTitle': 'Notifications are off',
  'reminders.permBody': 'Allow notifications so reminders can reach you.',
  ...
  'apiKeys.modelPlaceholder': 'Blank = auto-pick a capable model',
  'apiKeys.chooseModel': 'Choose from available',
  'apiKeys.refreshModels': 'Refresh list',
  'apiKeys.loadingModels': 'Loading models…',
  'apiKeys.modelsNeedKey': 'Enter the API key first, then choose a model.',
