...
2. He notices a feature for an AI assistant.  Familiar with AI agents, he clicks it.
3. He sees that he doesn't have the feature configured yet and is now in the very configuration screen to enable the feature.
4. The feature requires a selection of AI service and he has to supply his own API key.
...
12. He un-selects one and then approves the review screen.
...
- [ ] No final actions are taken without human preview and approval
